...
select "CODE","XZQHMC","YSDM","YSMC","GPMJ","BGMJ","CZ","CZL","CDMJ","JGPY","JTDBGY" from (select to_char('441320000000') code,to_char('»ÝÖÝÊÐ') xzqhmc,  a.ysdm,a.ysmc ,sum(a.gpmj) gpmj,sum(a.bgmj) bgmj,sum(a.gpmj) - sum(a.bgmj) cz ,
